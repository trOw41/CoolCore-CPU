...
Public Class Form2
    ...
    Private Sub LoadChartData()
        ...
        For Each coreName In allCoreNames
            ...
            .ChartType = SeriesChartType.RangeColumn.Column, '<- Chart Art Settings
            .XValueType = ChartValueType.DateTime,
            .YValueType = ChartValueType.Auto,
            .BorderWidth = 6,
            .IsValueShownAsLabel = True,
            .LabelFormat = "{0:F1}°C",
            .LabelBackColor = Color.FromArgb(200, Color.Gray),
            .LabelForeColor = Color.GhostWhite,
            .LabelBorderColor = Color.FromArgb(128, Color.Black),
